...
class DataRepositoryTest {
    ...
    public void searchPageSimple() throws Exception{
        ...
        Page<MemberTeamDTO> search = dataRepository.searchPage(condition, pageRequest);

        Assertions.assertThat(search.getSize()).isEqualTo(3);
        Assertions.assertThat(search.getContent())
                .extracting("username")
